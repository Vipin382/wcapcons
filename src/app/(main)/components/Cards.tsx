...
export default function Card(post: CardProps) {
  return (
    <article className="flex  bg-foreground-950 p-5 border border-foreground-900 hover:bg-foreground-950/60 cursor-pointer transition-all rounded-xl flex-col  items-start justify-between">
